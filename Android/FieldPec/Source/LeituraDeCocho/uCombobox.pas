...
type
  ...
  private
    ...
    lblTitulo, lblSubTitulo, lblItem, lblSubItem : TLabel;
    FTitleMenuText, FSubTitleMenuText, FCodItem, FNomeItem,FDescricaoItem,
    FDescricaoItem2 : string;
    FDescricaoItem1:Double;
  ...
  public
    ...
    procedure AddItem(codItem: string;ItemDescricao: string;itemText: string);
    procedure AddItem4(codItem,ItemDescricao,ItemDescricao2,itemText:string;
     ItemDescricao1:Double);
  ...
  published
    ...
    property NomeItem: String read FNomeItem write FNomeItem;
    property DescricaoItem: String read FDescricaoItem write FDescricaoItem;
    property DescricaoItem1: Double read FDescricaoItem1 write FDescricaoItem1;
    property DescricaoItem2: String read FDescricaoItem2 write FDescricaoItem2;
    {$IFDEF MSWINDOWS}
...
begin
    FCodItem        := intToStr(TLabel(Sender).Tag);
    FNomeItem       := TLabel(Sender).Text;
    FDescricaoItem  := TLabel(Sender).TagString;
    FDescricaoItem2 := TLabel(Sender).Hint;
    FDescricaoItem1 := TLabel(Sender).TagFloat;
    ACallBack(Sender);
end;
{$ELSE}
...
procedure TCustomCombo.AddItem(codItem: string;ItemDescricao: string;itemText: string);
begin
    // Fundo do item...
    ...
    begin
        ...
        Margins.Left := 10;
        Margins.Right := 10;
        Tag           := strToInt(codItem);
        TagString     := ItemDescricao;
        {$IFDEF MSWINDOWS}
        OnClick := ItemClick;
        {$ELSE}
        OnTap := ItemClick;
...
procedure TCustomCombo.AddItem4(codItem,ItemDescricao,ItemDescricao2,itemText:string;
 ItemDescricao1:Double);
begin
    rectItem := TRectangle.Create(vert);
    with rectItem do
